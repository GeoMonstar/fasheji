...
#define MOPUSH_TYPE_RECONNECT_REQ   MOPUSH_MSG_TYPE+25
#define MOPUSH_TYPE_PUBLISH_FILE        MOPUSH_MSG_TYPE+26

#define MAX_FILE_LEN                1024*500
...
static const char server_topic_base[] = "/mob/";
static const char server_type_0[]="/0/";
static const char server_type_1[]="/1/";
static const char server_type_2[]="/2/";
static const char server_type_3[]="/3/";
static const char server_type_4[]="/4/";
static const char server_type_5[]="/5/";
...
libmopush_EXPORTS void mopushSubOneself(mopush *mpush);
...
libmopush_EXPORTS int mopushPubMsg2Client(mopush *mpush, const char *clientId, int qos,int payloadlen, const void *payload);
    
libmopush_EXPORTS int mopushPubTokenToServerForApns(mopush *mpush,int payloadlen,const char *token);
    
libmopush_EXPORTS int mopushPubMessageTipToClient(mopush *mpush,const char *clientId,int qos,int payloadlen,const void *payload);

libmopush_EXPORTS int mopushPubCircleMessageTip(mopush *mpush,const char *circleName,int qos,int payloadlen,const void *payload);
    
libmopush_EXPORTS int mopushJoinCircleTip(mopush *mpush,const char *circleName,int qos,int payloadlen,const void *payload);
    
libmopush_EXPORTS int mopushDelCircleTip(mopush *mpush,const char *circleName,int qos,int payloadlen,const void *payload);
    
libmopush_EXPORTS int mopushQuitCircleTip(mopush *mpush,const char *circleName,int qos,int payloadlen,const void *payload);

libmopush_EXPORTS int mopushJoinCircle(mopush *mpush, const char *name);

libmopush_EXPORTS int mopushCreateCircle(mopush *mpush, const char *name , int num , char *idlist[]);

libmopush_EXPORTS int mopushDelCircle(mopush *mpush, const char *name);

libmopush_EXPORTS int mopushQuitCircle(mopush *mpush , const char *name);

libmopush_EXPORTS int mopushPubCircleMsg(mopush *mpush, const char *name, int payloadlen, const void *payload);
    
libmopush_EXPORTS int mopushPubFile2Client(mopush *mpush, const char *clientId, int qos,const char *filename);
    
libmopush_EXPORTS int mopushPubFileToCircleMsg(mopush *mpush, const char *name, const char *filename);
...
libmopush_EXPORTS const char *mopush_strerror(int mpush_errno);
...
libmopush_EXPORTS void mopush_subscribe_callback_set(mopush *mpush, void (*on_subscribe)(mopush *, void *, int, int, const int *));
